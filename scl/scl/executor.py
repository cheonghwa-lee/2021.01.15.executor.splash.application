            ...
            with _WaitSet() as wait_set, ExitStack() as context_stack:
                ...
                for idx in range(len(nodes_to_use)):
                    if "SourceLinearX" in str(nodes_to_use[idx]): # haya hard cording to be chaged
                        print('wooyoung: ', str(nodes_to_use[idx]))
                ...
                for sub in node.subscriptions:
                    ...
                    if sub.handle.pointer in subs_ready:
                        ...
                        if sub.callback_group.can_execute(sub):
                            ...
                            # print('tlqkf2')
                            # print(subs_ready)
                            print('check pointer: ', sub.handle.pointer)
                            # print(handler)
                            # print('chedk sub: ', sub)
                            print('check node: ', node)
                            # print(node.get_name)
                            # print(node.get_node_names)
                            # print(node.get_publishers_info_by_topic)
                            # print(node.get_subscriptions_info_by_topic)
                            # print('----------------------------------')
